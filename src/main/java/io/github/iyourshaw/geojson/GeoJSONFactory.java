...
public class GeoJSONFactory {
   ...
   */
  public static <TFeature extends BaseFeature<?, ?, ?>> TFeature createFeature(
      String json, Class<TFeature> featureType) {
   ...
   */
  public static <TFeatureCollection extends BaseFeatureCollection<?>>
      TFeatureCollection createFeatureCollection(
  ...
  private static Geometry readGeometry(JsonNode node, String type) {
    ...
    try {
      return (Geometry) mapper.convertValue(node, Class.forName(packageName + "." + type));
