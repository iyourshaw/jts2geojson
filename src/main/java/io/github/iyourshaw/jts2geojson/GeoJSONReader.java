...
import io.github.iyourshaw.geojson.GeoJSON;
import io.github.iyourshaw.geojson.GeoJSONFactory;
import io.github.iyourshaw.geojson.GeometryCollection;
import io.github.iyourshaw.geojson.LineString;
import io.github.iyourshaw.geojson.MultiLineString;
import io.github.iyourshaw.geojson.MultiPoint;
import io.github.iyourshaw.geojson.MultiPolygon;
import io.github.iyourshaw.geojson.Point;
import io.github.iyourshaw.geojson.Polygon;
...
public class GeoJSONReader {
  ...
  public Geometry read(GeoJSON geoJSON, GeometryFactory geomFactory) {
    ...
    factory = Objects.requireNonNullElse(geomFactory, FACTORY);

    return switch (geoJSON) {
      case Point point -> convert(point, factory);
      case LineString lineString -> convert(lineString, factory);
      case Polygon polygon -> convert(polygon, factory);
      case MultiPoint multiPoint -> convert(multiPoint, factory);
      case MultiLineString multiLineString -> convert(multiLineString, factory);
      case MultiPolygon multiPolygon -> convert(multiPolygon, factory);
      case GeometryCollection geometryCollection -> convert(geometryCollection, factory);
  ...
  Geometry convert(MultiLineString multiLineString, GeometryFactory factory) {
    ...
    org.locationtech.jts.geom.LineString[] lineStrings =
        new org.locationtech.jts.geom.LineString[size];
