...
public class JTSConverter {
   ...
   */
  public static org.locationtech.jts.geom.MultiLineString convertToJTS(
      MultiLineString multiLineString) {
    GeoJSONReader reader = new GeoJSONReader();
    return (org.locationtech.jts.geom.MultiLineString)
        reader.convert(multiLineString, GeoJSONReader.FACTORY);
  }
  ...
  public static org.locationtech.jts.geom.MultiPolygon convertToJTS(MultiPolygon multiPolygon) {
    ...
    return (org.locationtech.jts.geom.MultiPolygon)
        reader.convert(multiPolygon, GeoJSONReader.FACTORY);
  }
   ...
   */
  public static MultiLineString convertFromJTS(
