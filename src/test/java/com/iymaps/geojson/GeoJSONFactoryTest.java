...
public class GeoJSONFactoryTest {
    ...
    public void pointLonLatConstructorTest() {
        ...
        assertThat(
                "{\"type\":\"Point\",\"coordinates\":[-104.0,45.0]}",
                equalTo(point.toString()));
    }

    @Test
    public void createFeatureTest() {
        var feature = new Feature(geometry, properties);
        var expected = "{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[1.0,1.0]},\"properties\":{\"test\":1}}";
    ...
    public void createFeatureWithIdTest() {
        ...
        var expected = "{\"type\":\"Feature\",\"id\":1,\"geometry\":{\"type\":\"Point\",\"coordinates\":[1.0,1.0]},\"properties\":{\"test\":1}}";
        var json = feature.toString();
        assertThat(expected, equalTo(json));
        var geoJSON = GeoJSONFactory.create(json);
        assertThat(expected, equalTo(geoJSON.toString()));
    ...
    public void createFeatureCollectionTest() {
        var expected = "{\"type\":\"FeatureCollection\",\"features\":[{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[1.0,1.0]},\"properties\":{\"test\":1}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[1.0,1.0]},\"properties\":{\"test\":1}}]}";
