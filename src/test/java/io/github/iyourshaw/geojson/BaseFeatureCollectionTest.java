...
import io.github.iyourshaw.geojson.examples.ExamplePojoFeatureCollection;
...
public class BaseFeatureCollectionTest {
  ...
  public void parsePojoFeatureCollectionTest() {
    ...
    var featureColl =
        new ExamplePojoFeatureCollection(new ExamplePojoFeature[] {feature1, feature2});

    final var expected =
        "{\"type\":\"FeatureCollection\",\"features\":[{\"type\":\"Feature\",\"id\":\"f085e9c9-f1e9-41e7-92f9-a37979c7a23d\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[1.0,1.0]},\"properties\":{\"str\":\"test\",\"idx\":1}},{\"type\":\"Feature\",\"id\":\"f085e9c9-f1e9-41e7-0000-a37979c7a23d\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[2.0,2.0]},\"properties\":{\"str\":\"test2\",\"idx\":2}}]}";
    var json = featureColl.toString();
    assertThat(expected, jsonEquals(json));
    var createdFeatureColl =
        GeoJSONFactory.createFeatureCollection(json, ExamplePojoFeatureCollection.class);
