...
public class GeoJSONFactoryTest {
  ...
  public static void setup() {
    geometry = new Point(new double[] {1, 1});
  ...
  @Test
  public void pointLonLatConstructorTest() {
    var point = new Point(-104.0, 45.0);
    assertThat(new double[] {-104.0, 45.0}, equalTo(point.getCoordinates()));
    assertThat("{\"type\":\"Point\",\"coordinates\":[-104.0,45.0]}", equalTo(point.toString()));
  }
