...
public class GeoJSONFactoryXYZTest {
  ...
  public void createFeatureTest() {
    var expected =
        "{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[1.0,1.0,1.0]},\"properties\":{\"test\":1}}";
  ...
  public void createFeatureWithIdTest() {
    ...
    var expected =
        "{\"type\":\"Feature\",\"id\":1,\"geometry\":{\"type\":\"Point\",\"coordinates\":[1.0,1.0,1.0]},\"properties\":{\"test\":1}}";
  ...
  public void createFeatureCollectionTest() {
    var expected =
        "{\"type\":\"FeatureCollection\",\"features\":[{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[1.0,1.0,1.0]},\"properties\":{\"test\":1}},{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[1.0,1.0,1.0]},\"properties\":{\"test\":1}}]}";
    var feature = new Feature(geometry, properties);
  ...
  public void lineStringBboxPropertyTest() {
    var geoJSON =
        "{\"type\": \"FeatureCollection\", \"features\": [{\"type\": \"Feature\", \"id\": 1, \"geometry\": {\"type\": \"LineString\", \"coordinates\": [[0.0,0.0],[1.0,1.0]], \"bbox\": [0.0,0.0,1.0,1.0] }, \"properties\": {\"FID\": 335, \"PLAN_REF\": \"151\", \"APP_TYPE\": \"RETENTION\", \"LOCATION\": \"Knockglass, Ballinameen, Co. Roscommon.\", \"REC_DATE\": \"05/01/2015\", \"DESCRIPT\": \"Of entrance to existing forest plantation for extraction of timber at various times at \", \"APPSTATUS\": \"Application Finalised\", \"DEC_DATE\": \"20/02/2015\", \"DECISION\": \"Granted (Conditional)\", \"APPE_DEC\": \"n/a\", \"APPE_DAT\": \"n/a\", \"MOREINFO\": \"http://www.eplanning.ie/roscommoneplan/FileRefDetails.aspx?file_number=151\", \"WGS_LONG\": \"-8.31141\", \"WGS_LAT\": \"53.89448\"} }] }";
    var json = GeoJSONFactory.create(geoJSON);
    assertThat(json, instanceOf(FeatureCollection.class));
    var fc = (FeatureCollection) json;
    assertThat(fc.getFeatures(), arrayWithSize(greaterThan(0)));
  ...
  public void multiLineStringBboxPropertyTest() {
    var geoJSON =
        "{\"type\": \"FeatureCollection\", \"features\": [{\"type\": \"Feature\", \"id\": 1, \"geometry\": {\"type\": \"MultiLineString\", \"coordinates\": [[[0.0,0.0],[1.0,1.0]]], \"bbox\": [0.0,0.0,1.0,1.0] }, \"properties\": {\"FID\": 335, \"PLAN_REF\": \"151\", \"APP_TYPE\": \"RETENTION\", \"LOCATION\": \"Knockglass, Ballinameen, Co. Roscommon.\", \"REC_DATE\": \"05/01/2015\", \"DESCRIPT\": \"Of entrance to existing forest plantation for extraction of timber at various times at \", \"APPSTATUS\": \"Application Finalised\", \"DEC_DATE\": \"20/02/2015\", \"DECISION\": \"Granted (Conditional)\", \"APPE_DEC\": \"n/a\", \"APPE_DAT\": \"n/a\", \"MOREINFO\": \"http://www.eplanning.ie/roscommoneplan/FileRefDetails.aspx?file_number=151\", \"WGS_LONG\": \"-8.31141\", \"WGS_LAT\": \"53.89448\"} }] }";
    var json = GeoJSONFactory.create(geoJSON);
    assertThat(json, instanceOf(FeatureCollection.class));
    var fc = (FeatureCollection) json;
    assertThat(fc.getFeatures(), arrayWithSize(greaterThan(0)));
  ...
  public void polygonBboxPropertyTest() {
    var geoJSON =
        "{\"type\": \"FeatureCollection\", \"features\": [{\"type\": \"Feature\", \"id\": 1, \"geometry\": {\"type\": \"Polygon\", \"coordinates\": [[[0.0,0.0],[0.0,1.0],[1.0,1.0],[0.0,1.0],[0.0,0.0]]], \"bbox\": [0.0,0.0,1.0,1.0] }, \"properties\": {\"FID\": 335, \"PLAN_REF\": \"151\", \"APP_TYPE\": \"RETENTION\", \"LOCATION\": \"Knockglass, Ballinameen, Co. Roscommon.\", \"REC_DATE\": \"05/01/2015\", \"DESCRIPT\": \"Of entrance to existing forest plantation for extraction of timber at various times at \", \"APPSTATUS\": \"Application Finalised\", \"DEC_DATE\": \"20/02/2015\", \"DECISION\": \"Granted (Conditional)\", \"APPE_DEC\": \"n/a\", \"APPE_DAT\": \"n/a\", \"MOREINFO\": \"http://www.eplanning.ie/roscommoneplan/FileRefDetails.aspx?file_number=151\", \"WGS_LONG\": \"-8.31141\", \"WGS_LAT\": \"53.89448\"} }] }";
    var json = GeoJSONFactory.create(geoJSON);
    assertThat(json, instanceOf(FeatureCollection.class));
    var fc = (FeatureCollection) json;
    assertThat(fc.getFeatures(), arrayWithSize(greaterThan(0)));
  ...
  public void multiPolygonBboxProperty() {
    var geoJSON =
        "{\"type\": \"FeatureCollection\", \"features\": [{\"type\": \"Feature\", \"id\": 1, \"geometry\": {\"type\": \"MultiPolygon\", \"coordinates\": [[[[0.0,0.0],[0.0,1.0],[1.0,1.0],[0.0,1.0],[0.0,0.0]]]], \"bbox\": [0.0,0.0,1.0,1.0] }, \"properties\": {\"FID\": 335, \"PLAN_REF\": \"151\", \"APP_TYPE\": \"RETENTION\", \"LOCATION\": \"Knockglass, Ballinameen, Co. Roscommon.\", \"REC_DATE\": \"05/01/2015\", \"DESCRIPT\": \"Of entrance to existing forest plantation for extraction of timber at various times at \", \"APPSTATUS\": \"Application Finalised\", \"DEC_DATE\": \"20/02/2015\", \"DECISION\": \"Granted (Conditional)\", \"APPE_DEC\": \"n/a\", \"APPE_DAT\": \"n/a\", \"MOREINFO\": \"http://www.eplanning.ie/roscommoneplan/FileRefDetails.aspx?file_number=151\", \"WGS_LONG\": \"-8.31141\", \"WGS_LAT\": \"53.89448\"} }] }";
    var json = GeoJSONFactory.create(geoJSON);
    assertThat(json, instanceOf(FeatureCollection.class));
    var fc = (FeatureCollection) json;
    assertThat(fc.getFeatures(), arrayWithSize(greaterThan(0)));
